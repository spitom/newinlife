...
if (empty($children) || is_wp_error($children)) {
	...
	// Redirect tylko jeśli jest dokładnie 1 projekt
	// i term NIE jest ustawiony jako lista.
	if (
...
<main id="main-content" class="site-main site-main--projects-taxonomy">
	...
	<section class="page-section page-section--projects-taxonomy-intro">
		<div class="<?php echo esc_attr($container); ?>">
			<div class="projects-taxonomy-intro">
				<div class="row">
					<div class="col-xl-10">
						<?php if (!empty($term_intro)) : ?>
							<p class="projects-taxonomy-intro__lead">
								<?php echo esc_html($term_intro); ?>
							</p>
						<?php elseif (!empty($term->description)) : ?>
							<div class="projects-taxonomy-intro__lead">
								<?php echo wp_kses_post(wpautop($term->description)); ?>
							</div>
						<?php else : ?>
							<p class="projects-taxonomy-intro__lead">
								<?php echo esc_html(inlife_t('Wybierz odpowiedni obszar lub przejdź do listy projektów przypisanych do tej kategorii.')); ?>
							</p>
						<?php endif; ?>
					</div>
				</div>
