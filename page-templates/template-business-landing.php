...
$hero_title = inlife_get_acf_field(
	'business_hero_title',
	$post_id,
	inlife_t( 'Rozwiązania dla przemysłu i partnerów zewnętrznych' )
);

$hero_lead = inlife_get_acf_field(
	'business_hero_lead',
	$post_id,
	inlife_t( 'Wspieramy firmy i instytucje poprzez usługi laboratoryjne, transfer wiedzy, rozwój technologii oraz współpracę badawczo-rozwojową. Łączymy zaplecze naukowe z praktycznym podejściem do potrzeb biznesu.' )
);

$primary_label = inlife_get_acf_field(
	'business_hero_cta_primary_label',
	$post_id,
	inlife_t( 'Skontaktuj się z nami' )
);
...
<main id="main-content" class="site-main site-main--landing site-main--business">
	...
	<section id="business-contact" class="page-section page-section--business-contact" aria-labelledby="business-contact-heading">
		<div class="<?php echo esc_attr( $container ); ?>">
