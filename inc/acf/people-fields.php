			...
			[
				...
				'fields'                => [
					...
					[
						...
						'type'          => 'repeater',
						'instructions'  => __( 'Dodaj laboratoria, z którymi powiązana jest dana osoba. Możesz również oznaczyć kierownika laboratorium.', 'newinlife' ),
						'required'      => 0,
						'wrapper'       => [
							'width' => '100',
						],
						...
						'sub_fields'    => [
							...
							[
								'key'           => 'field_inlife_laboratory_membership_is_laboratory_manager',
								'label'         => __( 'Kierownik laboratorium', 'newinlife' ),
								'name'          => 'is_laboratory_manager',
								'type'          => 'true_false',
								'instructions'  => __( 'Zaznacz tylko wtedy, gdy ta osoba jest kierownikiem wybranego wyżej laboratorium.', 'newinlife' ),
								'required'      => 0,
								'wrapper'       => [
									'width' => '30',
								],
								'message'       => __( 'Ta osoba jest kierownikiem tego laboratorium', 'newinlife' ),
								'default_value' => 0,
								'ui'            => 1,
								'ui_on_text'    => __( 'Tak', 'newinlife' ),
								'ui_off_text'   => __( 'Nie', 'newinlife' ),
