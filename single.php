...
$format_term = ( ! empty( $format_terms ) && ! is_wp_error( $format_terms ) ) ? reset( $format_terms ) : null;
...
<main id="main-content" class="site-main site-main--single-post">
    ...
    <section class="page-section page-section--post-hero">
        ...
        $is_logo_like_hero = $hero_image_id && (
            $hero_image_width < 700 ||
            $hero_image_height < 360 ||
        ...
        if ( $hero_image_id ) {
            $hero_image_html = wp_get_attachment_image(
                $hero_image_id,
            ...
            $hero_image_caption = wp_get_attachment_caption( $hero_image_id );

            if ( '' !== trim( (string) $hero_image_caption ) ) {
                $hero_media_html = sprintf(
                    '<figure class="post-hero-poster">%1$s<figcaption class="post-hero-poster__caption">%2$s</figcaption></figure>',
                    $hero_image_html,
                    wp_kses_post( $hero_image_caption )
                );
            } else {
                $hero_media_html = $hero_image_html;
            }
        }
                            ...
                            <div class="post-content__footer">
                                ...
                                <div class="post-share__list">
                                    ...
                                    <button
                                        ...
                                        aria-label="<?php echo esc_attr( inlife_t( 'Kopiuj link do artykułu' ) ); ?>"
                                    >
                                    ...
                                    <a
                                        ...
                                        aria-label="<?php echo esc_attr( inlife_t( 'Wyślij artykuł e-mailem' ) ); ?>"
                                    >
    ...
    <?php if ( $latest_news && $latest_news->have_posts() ) : ?>
